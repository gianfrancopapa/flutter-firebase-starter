...
// in firebasestarter/test/services/auth/firebase_auth_test.dart.
...
import 'package:firebasestarter/models/user.dart' as _i7;
...
class MockFirebaseAuth extends _i1.Mock implements _i4.FirebaseAuth {
  ...
  _i5.Future<_i4.UserCredential>? createUserWithEmailAndPassword(
      ...
      (super.noSuchMethod(Invocation.method(#createUserWithEmailAndPassword, [],
...
class MockFirebaseAuthException extends _i1.Mock
    implements _i3.FirebaseAuthException {
...
/// A class which mocks [ISignInService].
///
/// See the documentation for Mockito's code generation for more information.
class MockISignInService extends _i1.Mock implements _i6.ISignInService {
  MockISignInService() {
    _i1.throwOnMissingStub(this);
  }
...
///
/// See the documentation for Mockito's code generation for more information.
class MockModelUser extends _i1.Mock implements _i7.User {
  MockModelUser() {
    _i1.throwOnMissingStub(this);
  }
...
/// A class which mocks [SignInServiceFactory].
///
/// See the documentation for Mockito's code generation for more information.
class MockSignInServiceFactory extends _i1.Mock
    implements _i6.SignInServiceFactory {
  @override
  void addService(
      ...
      super.noSuchMethod(
          Invocation.method(
              #addService, [], {#method: method, #constructor: constructor}),
          returnValueForMissingStub: null);
}
