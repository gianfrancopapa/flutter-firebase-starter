  ...
  Widget build(BuildContext context) {
    return MultiRepositoryProvider(
      providers: [
        ...
        RepositoryProvider.value(
            value: EmployeesRepository(FirebaseEmployeeDatabase())),
      ],
      child: MultiBlocProvider(
        providers: [
          ...
          BlocProvider(
            create: (context) =>
                EmployeesBloc(context.read<EmployeesRepository>())
...
class _FirebaseStarterState extends State<FirebaseStarter> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      navigatorObservers: [
        FirebaseAnalyticsObserver(analytics: context.read<FirebaseAnalytics>()),
      ],
    );
  }
}
